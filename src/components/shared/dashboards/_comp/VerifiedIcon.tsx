...
interface VerifiedSymbolProps {
  className?: string;
}

const VerifiedSymbol: React.FC<VerifiedSymbolProps> = ({ className }) => {
  return (
    <svg
      id="Layer_1"
      data-name="Layer 1"
      ...
      className={className} // Forward the className to the SVG
    >
      <defs>
